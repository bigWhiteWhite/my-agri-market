<template>
	<div class="code-login">
		...
		<!-- 选择验证码还是密码登陆按钮 -->
		<div class="switch">
			<span style="cursor: pointer;"><router-link :to="{name:'adminVaildCodeLogin'}">找回密码</router-link></span> 
			<span style="cursor: pointer;" @click="clear"><router-link :to="{name:'adminVaildCodeLogin'}" >使用短信验证码登录</router-link></span>
		</div>
